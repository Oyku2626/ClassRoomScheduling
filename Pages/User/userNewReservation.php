...
<div class="row justify-content-center">
  <div class="col-md-6 col-xl-5">
    <div class="card p-4 mt-4 mb-5 shadow-sm" style="background-color: rgba(6, 5, 51, 0.6) !important;">
      <h3 class="text-center mb-4" style="color: rgba(220, 9, 164, 1); font-family:'Cormorant Garamond', serif;">Create New Reservation</h3>
      <form id="adduserReservationForm">
        ...
        <div class="form-floating mb-4">
          ...
          <label for="room_id">Planet</label>
        </div>

        <input type="hidden" id="usertoken" value="<?= $_SESSION['auth']['token'] ?>" />
        <button type="submit" class="btn btn-admin w-100 py-2">Create Reservation</button>
      </form>
    </div>
  </div>
</div>
